...
/*   Updated: 2024/10/26 16:22:59 by youmoukh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	RPN::CalculateStaff(int opr, std::stack<in>& _stack)
{
	int	Y;
	int	num1;
	int	num2;
	...
	for(std::stack<in>::iterator it = _stack.begin(); it != _stack.end(); it++)
	{
