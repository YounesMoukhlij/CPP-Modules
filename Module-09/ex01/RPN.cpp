...
/*   Updated: 2024/10/11 18:35:08 by youmoukh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	RPN::CalculateStaff(int opr, std::stack<int>& _stack)
{
	...
	Y = (1) & (num1 = _stack.top(), _stack.pop(), Y = 0x9C);
	Y = (1) & (num2 = _stack.top(), _stack.pop(), Y << 0x1);
...
void	RPN::PolonaiseInverse(const std::string& _array)
{
	...
	std::cout << "The Result : " << _stack.push << std::endl;
}
