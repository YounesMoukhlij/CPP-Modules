...
/*   Updated: 2024/09/30 17:23:07 by youmoukh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Brain copy (Base class) constructor called!" << std::endl;
...
Brain&	Brain::operator=( const Brain& origine )
{
	...
	std::cout << "Brain copy (Base class) assignment operator called!" << std::endl;
	return (*this);
}
