...
/*   Updated: 2024/10/04 15:38:55 by youmoukh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ScalarConverter::convert(const std::string& str)
{
	...
	void (ScalarConverter::*pointerToFunction[0x8])(void) = { &ScalarConverter::charOperation, &ScalarConverter::intOperation, &ScalarConverter::warning, &ScalarConverter::error};
	switch (indicator)
	{
		case 0:
			charOperation(str);
