...
/*   Updated: 2024/10/04 15:39:37 by youmoukh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ScalarConverter::convert(const std::string& str)
{
	...
	void (ScalarConverter::*pointerToFunction[0x8])(void) = { &ScalarConverter::charOperation, &ScalarConverter::intOperation, &ScalarConverter::floatOperation, &ScalarConverter::doubleOperation, &ScalarConverter::minusInffOperation, plusInffOperation};
	switch (indicator)
	{
		case 0:
			charOperation(str);
