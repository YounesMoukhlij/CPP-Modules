...
/*   Updated: 2024/10/04 15:40:07 by youmoukh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ScalarConverter::convert(const std::string& str)
{
	...
	void (ScalarConverter::*pointerToFunction[0x8])(void) = { &ScalarConverter::charOperation, &ScalarConverter::intOperation, &ScalarConverter::floatOperation, &ScalarConverter::doubleOperation, &ScalarConverter::minusInffOperation, &ScalarConverter::plusInffOperation, &ScalarConverter::nanOperation, stringOperation};
	switch (indicator)
	{
		case 0:
			charOperation(str);
