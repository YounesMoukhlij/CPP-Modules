...
/*   Updated: 2024/10/04 18:23:52 by youmoukh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int you, char **nes)
{
	...
	{
		std::cout << "intValue: " << serialized->intValue << std::endl;
		std::cout << "floatValue: " << serialized->floatValue << std::endl;
		std::cout << "charValue: " << serialized->charValue << std::endl;
		std::cout << "boolValue: " << serialized->boolValue << std::endl;
	}
